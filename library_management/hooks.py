...
app_description = "Library Management System for Frappe v15+"
...
doc_events = {
    "Loan": {
        "before_save": "library_management.library_management.doctype.loan.loan.validate_loan_dates",
        "on_submit": "library_management.library_management.doctype.loan.loan.on_loan_submit",
        "on_cancel": "library_management.library_management.doctype.loan.loan.on_loan_cancel"
    }
}
...
# Fixtures - export roles and custom permissions
fixtures = [
    {"dt": "Role", "filters": [["name", "in", ["Librarian", "Library Member"]]]},
    {"dt": "Custom DocPerm", "filters": [["parent", "in", ["Book", "Member", "Loan"]]]},
]

# Website
website_route_rules = [
    {"from_route": "/library/my-loans", "to_route": "library_member_portal"},
]
